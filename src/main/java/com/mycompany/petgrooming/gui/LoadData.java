...
public class LoadData extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        String spCare= (String) cmbSpCare.getSelectedItem();
        String ownerName= txtOwnerName.getText();
        String phone= txtPhone.getText();
        String address= txtAddress.getText();
        
        logicControl.save(petName, breed, color, allergies, spCare, ownerName, phone, address);
        
        JOptionPane optionPane= new JOptionPane("The information was saved successfully");
        optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialog= optionPane.createDialog("Saved");
